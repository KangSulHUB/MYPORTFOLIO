...
@section('header_title', 'Tambah Riwayat')
...
<div class="max-w-5xl space-y-6">
    ...
    <div class="bg-white border border-slate-200 rounded-2xl p-6 md:p-8 shadow-sm">
        <h2 class="text-xl font-bold text-slate-800 border-b border-slate-100 pb-4 mb-6">Form Tambah Riwayat Baru</h2>
        ...
        <form action="{{ route('admin.experiences.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title') }}" required placeholder="Contoh: S1 Teknik Informatika / Data Engineer"
                ...
                <div>
                    ...
                    <input type="text" name="title_id" id="title_id" value="{{ old('title_id') }}" placeholder="Contoh: Analis Data" class="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 text-sm">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="company_or_institution" id="company_or_institution" value="{{ old('company_or_institution') }}" required placeholder="Contoh: Universitas Indonesia / PT Telekomunikasi"
                           class="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 text-sm">
            ...
            <div>
                ...
                <div class="flex gap-4">
                    <label class="inline-flex items-center cursor-pointer">
                        <input type="radio" name="type" value="experience" {{ old('type', 'experience') == 'experience' ? 'checked' : '' }}
                    ...
                    <label class="inline-flex items-center cursor-pointer">
                        <input type="radio" name="type" value="education" {{ old('type') == 'education' ? 'checked' : '' }}
                               class="w-4 h-4 text-indigo-600 bg-slate-50 border-slate-300 focus:ring-indigo-500">
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="5" placeholder="Sebutkan tanggung jawab Anda, hasil pencapaian, atau mata kuliah penting..."
